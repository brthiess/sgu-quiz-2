  ...
  <div class="quiz-footer-container" v-bind:class="{ active: active }">
    <div class="quiz-footer" v-bind:class="{ active: active }">
      <button
        ...
        v-bind:class="{ disabled: onFirstQuestion }"
      ...
      <div class="quiz-progress-container">
        <div class="quiz-progress">
          <div class="question-number-container">
            {{
              totalNumberOfQuestions >= activeSectionNumber
                ? activeSectionNumber + "/" + totalNumberOfQuestions
                : "End"
            }}
          </div>
          <ProgressRing
      ...
      <button
        ...
        v-bind:class="{ disabled: !nextSectionIsAvailable }"
        @click="goToNextQuestion"
      >
        {{ onLastQuestion ? "View Results" : "Next" }}
      </button>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    nextSectionIsAvailable: function() {
      return (
        this.activeSectionNumber <= this.totalNumberOfQuestions &&
        this.sections.length > 0 &&
        this.sections[this.activeSectionNumber - 1].answered
      );
    },
